...
class BinOp():
    ...
    def clampConvParams(self):
        for index in range(self.num_of_params):
            torch.clamp(self.target_modules[index].data,-1.0, 1.0,
    ...
    def Delta(self,tensor):
        n = tensor[0].nelement() # 1 + train epoch #n= 500 #n = 800 
	s = tensor.size()# 1 + train epoch s=(50,20,5,5)(25000) #s =(500,800) (400000)
